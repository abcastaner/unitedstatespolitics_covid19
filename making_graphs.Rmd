...
# FOR the first PLOTS - which visualize covid per month by county, for a 
# specific state.
...
f2 <- stan_glm(log_normalized_casesdec4 ~ favor_dem + favor_dem*pop_density_per1k,
         data = (data_formodel %>% 
...
# see the makeup of these 336 counties.
...
data_normalizingcases_withpop <- inner_join(for_deaths_st, population_data,
           by = c("combined_fips" = "FIPS_forjoin"))  
